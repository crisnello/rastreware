...
public class Conexao
{
	...
	throws SQLException
	{
		...
		{
			//TODO CHANGE
//			tArqConf = new FileInputStream("/jdbc_conf.txt");  //CONFIGURAR POR PROPERTIES!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
//			tNomeLog = tProps.getProperty ("log");
			...
			tNomeLog 	= "/home/nfreader/rastreamento/rastreamento_db.log";//"c:/temp/rastreamento_db.log";
			tDriver 	= "com.mysql.jdbc.Driver";
			tURL 		= "jdbc:mysql://208.97.172.196:3306/rastreware";

			
			
//			try{
//				tNomeLog = Utils.getProp().getProperty("tNomeLog");
//			}catch(Exception e){
//				System.out.println(tNomeLog);
//			}
